...
import LocateManageMent from "./Pages/Admin/ComponentAdmin/LocateManageMent";
          ...
          <HistoryRouter history={routeLink}>
            <Routes>
              ...
              <Route path="/admin" element={<AdminTemplate />}>
                ...
                <Route path="useraddnew" element={<UserDetailManageMent />} />
                ...
                <Route path="locate" element={<LocateManageMent />} />
                <Route
                  path="locateedit/:id"
                  element={<FormLocateManageMent />}
                />
                <Route path="locateaddnew" element={<FormLocateManageMent />} />
                <Route path="booking" element={<BookingManageMent />} />
                <Route
                  path="bookingedit/:id/:maNguoiDung/:maPhong"
                  element={<FormBookingManageMent />}
                />
              </Route>
            </Routes>
            <AlertGlobal />
